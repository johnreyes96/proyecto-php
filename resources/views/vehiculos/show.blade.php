            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/vehiculos/' . $vehiculo->id . '/edit') }}" title="Edit Vehiculo"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Placa </th><td> {{ $vehiculo->Placa }} </td></tr><tr><th> IdTipoVehiculo </th><td> {{ $vehiculo->IdTipoVehiculo }} </td></tr><tr><th> IdMarca </th><td> {{ $vehiculo->IdMarca }} </td></tr>
                                </tbody>
                            </table>
                        </div>
